...
Next we build a hi-res polygon of FL with the outplant sites marked. We use `ggspatial` to add a north arrow and scale bar to the main map. We are changing
